export default [
    {
        ...
        description: {
            ...
            ZH: "德國工程師**康拉德·楚澤**於1941年5月在柏林向科學家團隊展示了**Zuse Z3**。Z3是有史以來首台完全可運行且採用**二進位浮點運算**的**全自動程式控制電腦**。機器由大約2600個電磁繼電器構建而成（其中1400個用於記憶體，1200個用於算術運算與控制器），擁有64個字的儲存空間，每個字長22位元。其程式指令透過打孔35毫米電影膠片條輸入並逐條執行。1998年，電腦科學家勞爾·羅哈斯（Raul Rojas）進一步在數學上證明了Z3具備**圖靈完備性**（Turing Complete）。Z3毫無爭議地標誌著現代全自動計算設備的真正起源。",
        ...
        links: {
            wikipedia: {
                ...
                ZH: "https://zh.wikipedia.org/wiki/Z3%E8%AE%A1%E7%AE%97%E6%9C%BA",
