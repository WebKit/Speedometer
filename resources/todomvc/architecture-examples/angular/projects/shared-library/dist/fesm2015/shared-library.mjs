...
class TodoHeaderComponent {
    ...
    addTodo() {
        var _a;
        const title = (_a = this.titleFormControl.getRawValue()) === null || _a === void 0 ? void 0 : _a.trim();
        if (!title)
            return;
...
class TodoItemComponent {
    ...
    updateTodo() {
        var _a;
        const title = (_a = this.titleFormControl.getRawValue()) === null || _a === void 0 ? void 0 : _a.trimEnd();
        if (!title)
            this.deleteEvent.emit(this.todo);
        else
