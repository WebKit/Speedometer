...
export const App = () => {
    ...
    const { getTodos, addItem, updateItem, removeItem, toggleItem, removeCompletedItems } = useApi(storage);
    ...
    return (
        <>
            ...
            <Main todos={getTodos()} onToggle={handleToggleItem} onDelete={handleDeleteItem} onUpdate={handleUpdateItem} />
