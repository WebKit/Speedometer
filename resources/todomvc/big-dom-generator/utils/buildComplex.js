 ...
 * @param {string[]} options.cssFilesToAddLinksFor=["big-dom-generator-v1.css"] - An array of CSS files to add links for.
...
function buildComplex(options) {
    const {
        ...
        cssFilesToAddLinksFor = ["big-dom-generator-v1.css"],
    } = options;
    ...
    for (let i = 0; i < filesToMove.length; i++) {
        // Rename app.css to big-dom-generator-v1.css so it's unique
