...
const ProgressBar = ({ teamNumber, value, index }) => {
    return (
        <div
            className={classnames("spectrum-ProgressBar", "spectrum-Meter--sizeS", "is-negative", "analytics-bar")}
            value={value}
            role="progressbar"
            data-status={index}
            aria-valuenow={value}
            ...
            aria-valuemax="100"
        >
            <div className="spectrum-FieldLabel spectrum-FieldLabel--sizeS spectrum-ProgressBar-label">
                Team {teamNumber} progress
            </div>
            <div className="spectrum-FieldLabel spectrum-FieldLabel--sizeS spectrum-ProgressBar-percentage">
                {value}%
            </div>
