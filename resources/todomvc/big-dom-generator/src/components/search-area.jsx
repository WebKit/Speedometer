    ...
    return (
        <form className="spectrum-Search">
            <div className="spectrum-Textfield spectrum-Search-textfield">
                <SearchIcon
                    className="spectrum-Icon spectrum-Icon--sizeM spectrum-Textfield-icon spectrum-Search-icon"
                    focusable="false"
                    aria-hidden="true"
                    id="spectrum-icon-18-Magnify"
                />
                <input
                    type="search"
                    placeholder="Search"
            ...
            <button
                type="reset"
                className="spectrum-ClearButton spectrum-ClearButton--sizeM spectrum-Search-clearButton"
            >
                <div className="spectrum-ClearButton-fill">
                    <CrossIcon
                        className="spectrum-Icon spectrum-ClearButton-icon spectrum-UIIcon-Cross100"
                        focusable="false"
                    />
                </div>
            </button>
