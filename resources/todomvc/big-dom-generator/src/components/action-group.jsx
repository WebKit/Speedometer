...
export const ActionButton = ({ Icon, label, quiet, className, ...rest }) => {
    const buttonClassName = classnames(
        ...
        { "spectrum-ActionButton--quiet": quiet },
        className,
    );
    ...
    return (
        <button className={buttonClassName} {...rest}>
            {Icon
                && <Icon
                    className="spectrum-Icon spectrum-Icon--sizeM spectrum-ActionButton-icon"
                    focusable="false"
                    aria-hidden="true"
                />
            }
...
export const ActionGroup = ({ children }) => {
    return (
        <div className="spectrum-ActionGroup spectrum-ActionGroup--compact spectrum-ActionGroup--sizeM">{children}</div>
    );
};
