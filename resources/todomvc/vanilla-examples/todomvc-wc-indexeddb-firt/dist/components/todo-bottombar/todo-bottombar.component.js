...
class TodoBottombar extends HTMLElement {
    ...
    constructor() {
        ...
        this.buttons = {
            next: node.querySelector("#next-page-button"),
            previous: node.querySelector("#previous-page-button"),
            first: node.querySelector("#first-page-button"),
            last: node.querySelector("#last-page-button"),
        }
    ...
    moveToPage(page) {
        this.dispatchEvent(new CustomEvent("move-to-page", {detail: { page }}));
    }
