...
const options = {
    ...
    sourceDirectory: path.join("..", "node_modules", "todomvc-javascript-web-components-old", "dist"),
    title: "TodoMVC: JavaScript Web Components Old Complex DOM",
    filesToMove: [
    ...
    standaloneDirectory: path.resolve(__dirname, "..", "..", "javascript-web-components-old"),
