...
function createBreakpoints(breakpoints) {
  const {
    ...
    unit = "px",
    step = 5
  } = breakpoints, other = _objectWithoutPropertiesLoose$1(breakpoints, _excluded$O);
...
function createTheme$1(options = {}, ...args) {
  const {
    ...
    spacing: spacingInput,
    shape: shapeInput = {}
  } = options, other = _objectWithoutPropertiesLoose$1(options, _excluded$N);
...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ reactExports.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose$1(_extendSxProp, _excluded$L);
...
function processStyleArg(callableStyle, _ref) {
  let {
    ownerState
  } = _ref, props = _objectWithoutPropertiesLoose$1(_ref, _excluded$K);
  const resolvedStylesArg = typeof callableStyle === "function" ? callableStyle(_extends$3({
    ownerState
  }, props)) : callableStyle;
  if (Array.isArray(resolvedStylesArg)) {
    return resolvedStylesArg.flatMap((resolvedStyle) => processStyleArg(resolvedStyle, _extends$3({
      ownerState
    }, props)));
  }
  ...
  return (tag, inputOptions = {}) => {
    ...
    const transformStyleArg = (stylesArg) => {
      if (typeof stylesArg === "function" && stylesArg.__emotion_real !== stylesArg || isPlainObject(stylesArg)) {
        return (props) => processStyleArg(stylesArg, _extends$3({}, props, {
          theme: resolveTheme({
            theme: props.theme,
            defaultTheme: defaultTheme2,
            themeId
      ...
      if (componentName && overridesResolver2) {
        expressionsWithDefaultTheme.push((props) => {
          ...
          Object.entries(styleOverrides).forEach(([slotKey, slotStyle]) => {
            resolvedStyleOverrides[slotKey] = processStyleArg(slotStyle, _extends$3({}, props, {
              theme: theme2
            }));
          });
...
//# sourceMappingURL=index-9Z6NFx2K.js.map
