...
const ProgressBar = ({ teamNumber, value }) => {
    return (
        <div className="ui spectrum-ProgressBar spectrum-Meter--sizeS is-negative analytics-bar" value={value} role="progressbar" aria-valuenow={value} aria-valuemin="0" aria-valuemax="100">
